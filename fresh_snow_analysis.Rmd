...
fresh_snow_events_SASP <- fresh_snow_3%>%
  ...
  mutate(temp_cat = ifelse(temp_tminus1 > 0, ">0°C", 
                           ifelse(temp_tminus1 < 0 & temp_tminus1 > -10, "0°C to -10°C",
                                  ifelse(temp_tminus1 < -10 & temp_tminus1 > -20, "-10°C to -20°C", "<-20°C"))))%>%
  filter(!is.na(temp_cat))

fresh_snow_events_SASP$temp_cat <- factor(fresh_snow_events_SASP$temp_cat, levels = c(">0°C", "0°C to -10°C", "-10°C to -20°C", "<-20°C" ))
